...
impl Skills {
    ...
    pub(crate) fn new(hit_window: f64, rx: bool, radius: f32, fl: bool) -> Self {
        ...
        skills.push(Skill::aim(true, rx));
        skills.push(Skill::aim(false, rx));
...
impl Skill {
    #[inline]
    pub(crate) fn aim(with_sliders: bool, relax: bool) -> Self {
        Self::new(SkillKind::aim(with_sliders, relax))
    }
